                  ...
                  <tbody>
                    {
                      projects.data.map((data) => (
                        ...
                        <tr key={data.id} className='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
                          ...
                          <td className='px-3 py-2'>
                            <img src={data.image_path} className="w-10 h-10 rounded-full" alt={data.name} />
                          </td>
                          <td className='px-3 py-2 flex gap-5'>
                            <Link href={route('project.edit', data.id)} className='font-medium text-blue-600 hover:text-blue-500 underline'>Edit</Link>
                            <Link href={route('project.destroy', data.id)} className='font-medium text-red-600 hover:text-blue-500 underline'>Delete</Link>
                          </td>
                        </tr>
                      ))
                    }
